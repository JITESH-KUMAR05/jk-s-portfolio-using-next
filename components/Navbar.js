                                ...
                                <div className="flex gap-3 relative ml-3">
                                    <div className='hidden md:flex items-center justify-center gap-3'>
                                        <ul className="flex gap-5">
                                            <li>
                                                <a href="https://www.linkedin.com/in/jitesh-kumar-5190ba240/" target="_blank" rel="noopener noreferrer">
                                            ...
                                            <li>
                                                <a href="https://github.com/JITESH-KUMAR05/" target="_blank" rel="noopener noreferrer">
                                                    <svg
                                            ...
                                            <li>
                                                <a href="https://www.instagram.com/j_k__05__/" target="_blank" rel="noopener noreferrer">
                                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" className="h-[24px] w-[24px] hover:text-[#c043bce7]">
                                                        <path
                                                            className="fill-current text-white hover:text-[#c043bce7]"
                                            ...
                                            <li>
                                                <a href="https://discordapp.com/users/jk05_/" target="_blank" rel="noopener noreferrer">
                                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" className="h-[24px] w-[24px] hover:text-[#c043bce7]">
                                                        <path
                                                            className="fill-current text-white hover:text-[#c043bce7]"
                                            ...
                                            <li>
                                                <a href="https://twitter.com/Jitesh_Kumar05" target="_blank" rel="noopener noreferrer">
                                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="h-[24px] w-[24px] hover:text-[#c043bce7]">
                                                        <path
                                                            className="fill-current text-white hover:text-[#c043bce7]"
                                        ...
                                        {/* Optional: Add functionality to close dropdown when clicking outside */}
                                    </div>
                                    <button
                                        type="button"

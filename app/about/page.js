      ...
      <div className='w-full flex  h-[82vh]  p-7 border rounded-2xl overflow-hidden '>
        <div className="w-1/2 text-xl h-full flex flex-col gap-6 justify-center  px-5">
          ...
          <Link className='' href={'https://drive.google.com/file/d/1G6lkdxCgRJlyqSQyVmqrHjQsRXIz9sMj/view?usp=sharing'} target='_blank' >
            <button className="cursor-pointer w-1/2 inline-flex items-center rounded-full px-9 py-3 text-xl font-mono font-semibold text-rose-600 hover:text-white border-2 border-rose-600
